...
class OnceLoginPage extends StatefulWidget {
   Function onceLogin;
   OnceLoginPage({
     this.onceLogin
   });
  @override
  _OnceLoginPageState createState() => _OnceLoginPageState();
}

class _OnceLoginPageState extends State<OnceLoginPage> {
 /// 统一 key
